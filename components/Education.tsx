    ...
    return (
        <section className='w-full bg-black py-2'>
            <div className='max-w-sm md:max-w-8xl mx-auto p-5 md:p-10 rounded-2xl'>
                ...
                <div className='relative max-w-sm md:max-w-7xl mx-auto w-full h-96 flex items-center justify-start mt-5 rounded-2xl bg-white/10 overflow-hidden bg-[url("/images/education_bg.png")] bg-no-repeat bg-center' style={{ backgroundSize: "100%" }}>

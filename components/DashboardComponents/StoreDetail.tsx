...
const StoreDetail = ({ id, title, image, content, category }: StoreProps) => {
    ...
    return (
        <div className='w-full flex flex-col items-center justify-center text-white gap-5'>
            <div className='w-full flex items-center justify-center rounded-xl p-4 gap-5 bg-white/10'>
                <div className='flex items-center justify-end'>
                    <div className='w-44 h-28 flex items-center justify-center bg-white/95 rounded-xl'>
                        <Image src={image} alt={title} height={300} width={300} className='w-32' />
                    </div>
                </div>
                <div className='flex flex-col items-start justify-center gap-2 text-white p-5'>
                    <h1 className='text-xl font-semibold'>{title}</h1>
                    <h2 className='text-lg font-medium'>Earn 24k Gold upto 23.68% per Transaction on your Orders</h2>
                    <button className='px-5 py-3 text-base bg-gold-200 text-black rounded-2xl'>Activate Rewards</button>
                </div>
            </div>
            <div className='w-full flex items-start justify-center gap-4'>
                <div className='w-1/4 h-full flex flex-col items-center justify-start gap-5'>
                    <div className='w-full h-full flex flex-col items-center justify-start gap-5'>
                        <div className='p-4 flex flex-col items-center justify-center gap-2 bg-white/10 text-white rounded w-full'>
                            <h1 className='w-full text-xl font-semibold text-gold-200'>How to get this offer?</h1>
                    ...
                    <div className='w-full h-full flex flex-col items-center justify-start gap-5'>
                        <div className='p-4 flex flex-col items-center justify-center gap-2 bg-white/10 rounded w-full'>
                            <h1 className='w-full text-xl font-semibold text-gold-200'>Conversion Flow</h1>
                            ...
                            <p className='text-sm'><span className='font-semibold text-gold-500 text-base'>Note: </span>In some cases, the sale tracking only works after the shipment has been dispatched & it can take up-to 48 hours for the transaction to be visible in your Value1 Dashboard.</p>
                        </div>
                    </div>
                    <div className='w-full h-full flex flex-col items-center justify-start gap-5'>
                        <div className='p-4 flex flex-col items-center justify-center gap-2 bg-white/10 rounded w-full'>
                            <h1 className='w-full text-xl font-semibold text-gold-200'>Terms & Conditions:</h1>
                            <div>
                                <Table>
                                    <TableBody>
                ...
                <div className='w-3/4 flex flex-col items-center justify-center gap-5'>
                    <div className='w-full flex flex-col items-start justify-center gap-2 p-4 bg-white/10 rounded'>
                        <h1 className='w-full text-xl font-semibold text-gold-200 mb-2'>Rewards Details</h1>
                        <Table>
                            <TableHeader>
                                <TableRow>
                                    <TableHead className='text-lg font-semibold text-gold-200'>Category</TableHead>
                                    <TableHead className="w-[150px] text-lg font-semibold text-gold-200">Rewards</TableHead>
                                </TableRow>
                            </TableHeader>
                            <TableBody>
                    ...
                    <div className='w-full flex flex-col items-start justify-center gap-2 p-4 bg-white/10 rounded'>
                        <h1 className='w-full text-xl font-semibold text-gold-200'>Also Remember</h1>
                    ...
                    <div className='flex flex-col items-start justify-center gap-4 p-4 bg-white/10 rounded w-full'>
                        <h1 className='w-full text-xl font-semibold text-gold-200'>About Store</h1>
                        ...
                        <button className='text-base text-gold-500 font-medium flex items-center gap-2' onClick={() => handleReadMore()}>

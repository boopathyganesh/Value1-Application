...
const BigCard = ({ image }: CardProps) => {
    return (
        <div className='flex  items-center justify-between w-[750px] h-80 p-4 bg-white/10 text-white rounded-2xl overflow-hidden'>
            ...
            <div className='flex flex-col items-center justify-center gap-1.5 text-white p-5'>
                ...
                <button className='text-black p-3 mt-5 bg-gold-200 rounded-lg font-semibold'>Book Now!</button>
            </div>
        </div>
    )
}

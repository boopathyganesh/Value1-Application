...
export default function TopStores() {
	...
	return (
		<main className="flex flex-col text-gold-500 items-center justify-center gap-5 mt-2 w-full">
			<div className='relative max-w-7xl w-full flex items-center justify-center mt-5 rounded-2xl bg-gold-200/70 overflow-hidden'> {/*max-w-6xl*/}
				<div className='w-full h-52 flex items-center justify-end bg-[url("/images/Asset-28.png")] bg-contain bg-left-bottom bg-no-repeat'>
					<div className='px-10 max-w-lg w-full flex flex-col items-center justify-center gap-4'>
						<h1 className="text-right text-3xl font-semibold text-white">Check out these Awesome Deals Online</h1>
						<button className='border-2 border-gold-500 rounded-xl p-3 text-white text-base font-medium'>Join Now</button>
					</div>
				</div>
			</div>
